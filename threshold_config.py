...
def get_threshold_summary(signal_type: str) -> str:
    ...
    return (f"Threshold ≥{config['threshold']:.1f} | "
...
def get_all_thresholds_summary() -> str:
    ...
    """
    summary_lines = []
    summary_lines.append("📊 EMPIRICALLY VALIDATED THRESHOLDS SUMMARY")
    ...
    for signal_type in OPTIMAL_THRESHOLDS:
        ...
        summary_lines.append(f"   Threshold: ≥{config['threshold']:.1f}")
    ...
    summary_lines.append("")
    summary_lines.append("💡 USAGE NOTES:")
    summary_lines.append("• EXCELLENT/GOOD thresholds: Use for primary trading decisions")
    summary_lines.append("• FAIR thresholds: Use for secondary signals or smaller positions") 
    summary_lines.append("• POOR thresholds: Avoid or re-optimize with more data")
    summary_lines.append("• All thresholds based on entry-to-exit backtest validation")
...
if __name__ == "__main__":
    print("📊 EMPIRICALLY VALIDATED SIGNAL THRESHOLDS")
    print("=" * 50)
    print()
